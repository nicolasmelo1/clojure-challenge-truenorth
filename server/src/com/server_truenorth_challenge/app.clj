(ns com.server-truenorth-challenge.app
...
(defn notify-clients [{:keys [com.server-truenorth-challenge/chat-clients]} tx]
...
(defn ws-handler [{:keys [com.server-truenorth-challenge/chat-clients] :as ctx}]
  {:status 101
